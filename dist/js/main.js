...
/* harmony import */ var _portfolio__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./portfolio */ "./assets/js/portfolio.js");
/* harmony import */ var _footer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./footer */ "./assets/js/footer.js");
...
/* harmony import */ var _tagline__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tagline */ "./assets/js/tagline.js");
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Mousewheel, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.FreeMode]);
var Portfolio = /*#__PURE__*/function () {
  function Portfolio() {
    _classCallCheck(this, Portfolio);
    this.module = document.querySelector('.portfolio');
    this.element = document.querySelector('.portfolio__wrapper');
    this.autoplay = 5000;
    this.speed = 800;
    this.sliderHoverEvent = false;
    this.sliderHoverEventInterval = false;
    this.swiper = null;
    this.init();
  }
  return _createClass(Portfolio, [{
    ...
    value: function slider() {
      ...
      swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](this.element, options);
    }
  }]);
}();
...
var Tagline = /*#__PURE__*/function () {
  function Tagline() {
    _classCallCheck(this, Tagline);
    this.typeSplit = null;
    this.elements = document.querySelectorAll('.tagline__wrapper p');
    this.init();
  }
  return _createClass(Tagline, [{
    key: "init",
    value: function init() {
    ...
    value: function splitText() {
      this.typeSplit = new split_type__WEBPACK_IMPORTED_MODULE_0__["default"](this.elements, {
        types: 'lines, words'
      });
      this.elements.forEach(function (element) {
        element.querySelectorAll('.line').forEach(function (line) {
          line.insertAdjacentHTML('beforeend', '<div class="line-mask"></div>');
        });
      });
      this.runAnimation();
    }
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkportfolio_v2"] = self["webpackChunkportfolio_v2"] || [];
